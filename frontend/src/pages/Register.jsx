      ...
      >
        ...
        <div className="p-8 md:p-16 lg:p-20 flex flex-col justify-center items-center relative overflow-hidden bg-[#131313] order-2 md:order-1">
          ...
          >
            ...
            <motion.p
              className="text-center text-sm text-white/30 mt-12 md:mt-16 font-inter"
              variants={itemVariants}
            >
              Already have an account?{' '}
              <Link
                to="/login"
                className="text-white font-bold hover:underline transition-all tracking-wide decoration-white decoration-2 underline-offset-8"
              >
                Sign In
              </Link>
            </motion.p>
