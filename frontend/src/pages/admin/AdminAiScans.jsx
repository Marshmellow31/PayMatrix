              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2.5">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-white/40">
                      Latency:{' '}
                      <span className="text-white/80 font-mono">{log.duration || '0'} ms</span>
                    </p>
                    <p className="text-white/40">
                      Model:{' '}
                      <span className="text-white/80 font-mono">{log.model || 'Unknown'}</span>
                    </p>
                    <p className="text-white/40">
                      User UID: <span className="text-white/80 font-mono">{log.uid}</span>
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-2.5">
                  ...
                  {isPassed ? (
                    <div className="space-y-1 bg-white/[0.02] p-3 rounded-xl border border-white/[0.05]">
                      ...
                      <p className="text-white/40">
                        Items Extracted:{' '}
                        <span className="text-white/80 font-bold">{log.itemsCount || 0} items</span>
                      </p>
                    </div>
                  ) : (
                    <div className="bg-red-500/5 p-3 rounded-xl border border-red-500/10 space-y-1 text-red-400/80 font-mono">
                      ...
                      <p className="break-all text-[11px] leading-normal">
                        {log.error || 'Unknown scanner error'}
                      </p>
                    </div>
                  )}
                </div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-white/40 mt-0.5">
            Performance and logs of Gemini Receipt Scanner
          </p>
        </div>
        <button
