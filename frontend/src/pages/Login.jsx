    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              style={{ width: '20px', height: '20px', background: '#0e0e0e', borderRadius: '5px' }}
            />
          </div>
          <span
            style={{
        ...
        >
          ...
          >
            A highly secure, synchronized vault for modern wealth management — built for precision
            and peace of mind.
          </p>
        ...
        <div style={{ width: '100%', maxWidth: '360px', position: 'relative', zIndex: 1 }}>
          ...
          >
            ...
            <p style={{ fontSize: '14px', color: 'rgba(255,255,255,0.38)', lineHeight: 1.65 }}>
              Sign in to access your secure digital vault. Your data is always encrypted and
              private.
            </p>
          </motion.div>
          ...
          >
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  '0 8px 40px rgba(0,0,0,0.5), 0 1px 0 rgba(255,255,255,0.1) inset';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'scale(1)';
                e.currentTarget.style.boxShadow =
                  '0 4px 32px rgba(0,0,0,0.4), 0 1px 0 rgba(255,255,255,0.1) inset';
              }}
              onMouseDown={(e) => {
            ...
            >
              ...
              <p style={{ fontSize: '12px', color: 'rgba(255,255,255,0.25)', lineHeight: 1.65 }}>
                Secure PayMatrix infrastructure. All data is end-to-end encrypted with AES-256
                standard protocols.
              </p>
