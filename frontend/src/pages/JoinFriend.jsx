...
import { UserPlus, Check, X, Loader2, ShieldCheck, Zap, Users, ArrowLeft } from 'lucide-react';
      ...
      return (
        <div className="text-center py-20 space-y-8">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-white/30 font-medium px-10">
              You must be logged into the Social Matrix to accept connections.
            </p>
          </div>
          <button
      ...
      <div className="space-y-10">
        ...
        <div className="flex items-center justify-center gap-4 text-white/10">
          ...
          <p className="text-[9px] font-bold uppercase tracking-[0.5em] whitespace-nowrap">
            Encrypted Invitation Protocol v4
          </p>
