...
const ActivityFeed = ({ groupId, externalLogs }) => {
  ...
  if (loading)
    return (
      <div className="py-12 animate-pulse text-center text-on-surface-variant font-medium">
        Gathering history...
      </div>
    );
                  ...
                  >
                    {typeof activity.message === 'string'
                      ...
                      : activity.message?.message ||
                        `${activity.actorName || 'Someone'} performed an action`}
      ...
      >
        <div className="flex flex-col gap-6 py-4">
          <p className="text-sm font-medium text-on-surface-variant font-inter leading-relaxed">
            ...
            <br />
            <br />
            This will <span className="text-white font-bold">revert the balances</span> back to
