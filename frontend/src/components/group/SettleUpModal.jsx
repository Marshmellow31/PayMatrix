      ...
      results.forEach(({ uid, data }) => {
        details[uid] = data
          ? {
              upiId: data.upiId || '',
              name: data.name || '',
              preferredApp: data.preferredApp || 'default',
            }
          : null;
      });
                  ...
                  {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-12 text-center">
                      ...
                      <p className="text-sm text-on-surface-variant font-inter">
                        {forcedPayeeId
                          ? 'You have no outstanding dues with this member.'
                          : 'You have no outstanding dues in this group.'}
                      </p>
                      <Button onClick={onClose} className="mt-8 px-8">
                        Close
                      </Button>
                    </div>
                  ) : (
                    <div className="flex flex-col gap-6">
                      ...
                      <h4 className="text-sm font-semibold text-on-surface-variant font-inter mt-2 mb-1">
                        {forcedPayeeId
                          ? 'Specific Debt for Reconciliation'
                              ...
                              >
                                <div className="relative flex items-center gap-4 p-5 rounded-2xl bg-white/[0.03] border border-white/5 overflow-hidden">
                                  ...
                                  <div className="flex-1 min-w-0 pr-12">
                                    <p className="text-[10px] text-white/30 font-black uppercase tracking-widest leading-none mb-2">
                                      You should pay
                                    </p>
                                    ...
                                    <div className="flex gap-2">
                                      ...
                                      <Button
                                        ...
                                        disabled={
                                          ...
                                          parseFloat(partialPayment.amount) <= 0
                                        }
                      ...
                      <p className="text-[10px] text-on-surface-variant font-inter italic opacity-60 text-center mt-2 px-4">
                        These suggestions use a min-flow algorithm to prevent redundant transfers
                          ...
                          <div className="flex flex-wrap gap-x-4 gap-y-3 pt-1 max-h-[260px] overflow-y-auto pr-1 custom-scrollbar">
                            {members.map((m) => {
                              ...
                              return (
                                ...
                                >
                                  <div
                                    className={`w-12 h-12 rounded-2xl flex items-center justify-center text-sm font-black transition-all border-2 overflow-hidden ${
                                      isSelected
                                  ...
                                  <span
                                    className={`text-[8px] font-black uppercase tracking-wide w-14 text-center truncate transition-colors ${
                                      isSelected
                                        ? 'text-violet-400'
                          ...
                          <div className="flex flex-col gap-2">
                            ...
                            {flags.upiDeepLinks && (
                              <button
                                ...
                                onClick={() => {
                                  if (isValid) handleUPIPay(customDebt, receiverDetails);
                                }}
                                title={
                                  !payeeUid
