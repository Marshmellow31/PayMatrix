...
instructions = """# Build paymatrix 2.3.1
...
with zipfile.ZipFile(archive, "w", zipfile.ZIP_DEFLATED) as z:
    ...
    for release_doc in [
        root / "docs/ANDROID_EXPERIENCE_PLAN_2026-09-08.md",
        root / "docs/RELIABILITY_AND_EXPERIENCE_2026-09-09.md",
        root / "docs/SPLITWISE_COMPARISON_2026-09-09.md",
        native / "docs/RELEASE_2.3.1.md",
    ]:
        z.write(release_doc, "docs/" + release_doc.name)
