...
3. The version code increases: v2.0.2 uses `20200`.
...
The GitHub release is published as a prerelease named `paymatrix 2.0.2`, not as beta-branded software. Its notes explicitly say it may contain bugs and link users to report them. Older releases are not deleted or overwritten.
